...
/***/ "./src/js/components/slick-init.ts":
/*!*****************************************!*\
  !*** ./src/js/components/slick-init.ts ***!
  \*****************************************/
...
function initSlickSliders(varFromPhp) {
  var heroVer2Group1Slider = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.js-hero-ver-2-group-1');
  var heroVer2Group2Slider = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.js-hero-ver-2-group-2');
  var heroVer2Group3Slider = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.js-hero-ver-2-group-3');
  var group1Speed = varFromPhp.hero_version_2_group_1_speed ? varFromPhp.hero_version_2_group_1_speed : 5000;
  var group2Speed = varFromPhp.hero_version_2_group_2_speed ? varFromPhp.hero_version_2_group_2_speed : 5000;
  var group3Speed = varFromPhp.hero_version_2_group_3_speed ? varFromPhp.hero_version_2_group_3_speed : 5000;
  if (heroVer2Group1Slider && heroVer2Group2Slider && heroVer2Group3Slider) {
    ...
    heroVer2Group1Slider.slick(jquery__WEBPACK_IMPORTED_MODULE_1___default().extend({}, commonInitOptions));
    heroVer2Group2Slider.slick(jquery__WEBPACK_IMPORTED_MODULE_1___default().extend({}, commonInitOptions));
    heroVer2Group3Slider.slick(jquery__WEBPACK_IMPORTED_MODULE_1___default().extend({}, commonInitOptions));
...
var SlickSliders = {
  initSlickSliders: initSlickSliders
};
/* harmony default export */ __webpack_exports__["default"] = (SlickSliders);

/***/ }),

/***/ "./src/js/components/swiper-init.ts":
/*!******************************************!*\
  !*** ./src/js/components/swiper-init.ts ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = (SwiperSliders);

/***/ }),

/***/ "./src/js/components/toggleBurgerMenu.ts":
/*!***********************************************!*\
  !*** ./src/js/components/toggleBurgerMenu.ts ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = (toggleBurgerMenu);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _toggleBurgerMenu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toggleBurgerMenu */ "./src/js/components/toggleBurgerMenu.ts");
...
var toggleCurrentMenuItem = function toggleCurrentMenuItem() {
  ...
  if (burgerMenu && burgerMenu.classList.contains('burger-active')) (0,_toggleBurgerMenu__WEBPACK_IMPORTED_MODULE_0__["default"])();
};
/* harmony default export */ __webpack_exports__["default"] = (toggleCurrentMenuItem);

/***/ }),

/***/ "./src/js/components/toggleProjectControlsBtn.ts":
/*!*******************************************************!*\
  !*** ./src/js/components/toggleProjectControlsBtn.ts ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function _arrayWithoutHoles(r) { if (Array.isArray(r)) return _arrayLikeToArray(r); }
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
var toggleProjectControlsBtn = function toggleProjectControlsBtn(target) {
  var projectControlsBtnArr = window.document.querySelectorAll('.js-project-controls-btn');
  var projectGalleryControls = window.document.querySelector('.js-project-gallery-controls');
  if (!projectControlsBtnArr || !projectGalleryControls) return;
  var isActiveReadMoreBtn = target.classList.contains('project-read-more-btn') ? 'toggle' : 'remove';
  _toConsumableArray(projectControlsBtnArr).forEach(function (btn) {
    var actionType = btn === target ? 'toggle' : 'remove';
    btn.classList[actionType]('btn-active');
  });
  projectGalleryControls.classList[isActiveReadMoreBtn]('read-more-active');
};
/* harmony default export */ __webpack_exports__["default"] = (toggleProjectControlsBtn);
...
/* harmony import */ var _components_slick_init__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/slick-init */ "./src/js/components/slick-init.ts");
/* harmony import */ var _components_swiper_init__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/swiper-init */ "./src/js/components/swiper-init.ts");
/* harmony import */ var _components_toggleCurrentMenuItem__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/toggleCurrentMenuItem */ "./src/js/components/toggleCurrentMenuItem.ts");
/* harmony import */ var _components_toggleScrollBtnTop__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/toggleScrollBtnTop */ "./src/js/components/toggleScrollBtnTop.ts");
/* harmony import */ var _components_toggleBurgerMenu__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/toggleBurgerMenu */ "./src/js/components/toggleBurgerMenu.ts");
/* harmony import */ var _components_toggleProjectControlsBtn__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/toggleProjectControlsBtn */ "./src/js/components/toggleProjectControlsBtn.ts");
function _toConsumableArray(r) { return _arrayWithoutHoles(r) || _iterableToArray(r) || _unsupportedIterableToArray(r) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _iterableToArray(r) { if ("undefined" != typeof Symbol && null != r[Symbol.iterator] || null != r["@@iterator"]) return Array.from(r); }
  ...
  document.body.addEventListener('click', function (event) {
    ...
    switch (ROLE) {
      ...
      case 'toggle-burger-menu':
        {
          (0,_components_toggleBurgerMenu__WEBPACK_IMPORTED_MODULE_7__["default"])();
          break;
        }
      case 'toggle-project-controls-btn':
        {
          (0,_components_toggleProjectControlsBtn__WEBPACK_IMPORTED_MODULE_8__["default"])(target);
          break;
        }
      default:
        break;
